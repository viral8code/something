...
final class Main {
	...
	public static void main ( String[] args ) {
		...
		class Node{
			...
			int next0,next1;
			int len;
			Node(int m0,int m1,int b0,int b1,int n0,int n1,int l){
				max0 = m0;
				max1 = m1;
				bef0 = b0;
				bef1 = b1;
		...
		SegmentTree<Node> segT = new SegmentTree(N,new Node(0,0,0,0,0,0,1),true){
			public Node function(Node a,Node b){
				int len = a.len+b.len;
				int bef0 = a.max0==a.len0?a.bef0+b.bef0:a.bef0;
				int bef1 = a.max1==a.len1?a.bef1+b.bef1:a.bef1;
				int next0 = b.max0==b.len?a.next0+b.next0:b.next0;
				int next1 = b.max1==b.len?a.next1+b.next1:b.next1;
				int max0 = MathFunction.max(bef0,next0,a.next0+b.bef0,a.max0,b.max0);
				int max1 = MathFunction.max(bef1,next1,a.next1+b.bef1,a.max1,b.max1);
				Node ans = new Node(max0,max1,bef0,bef1,next0,next1,len);
				return ans;
			}
		};
		for(int i=1;i<=N;i++){
			segT.update(S[i-1]=='0'?
				new Node(1,0,1,0,1,0,1):
				new Node(0,1,0,1,0,1,1));
		}
		while(Q-->0){
