...
class Main{
	...
	public static int[][] set(int[][] map,int way){
		int[][] next = new int[10][10];
		if(way==0){
			ArrayList<ArrayDeque<Integer>> stack = new ArrayList<ArrayDeque<Integer>>();
	...
	public static int dfs(int x,int y,int[][] map,boolean[][] checked){
		int ans = 1;
