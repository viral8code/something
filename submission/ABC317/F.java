...
final class Main {
	...
	public static void main ( String[] args ) {
		...
		long N = sc.nextLong();
		int[] A = sc.nextInt(3);
		int lcm = (int)MathFunction.lcm(MathFunction.lcm(A[0],A[1]),A[2]);
		if(lcm>N)
			lcm = (int)N;
		long sum = 0;
		for(int i=A[0];i<=lcm;i+=A[0])
			for(int j=A[1];j<=lcm;j+=A[1])
				for(int k=A[2];k<=lcm;k+=A[2])
					if((i^j^k)==0)
						sum++;
		out.println("pri:"+sum);
		sum = sum*(N/lcm)%mod;
...
final class ArrayFunction {
	 ...
	 * @param d 交換先の第2インデックス
	 */
	public static void swap ( long[][] array, int a, int b, int c, int d ) {
	 ...
	 * @param d 交換先の第2インデックス
	 */
	public static void swap ( double[][] array, int a, int b, int c, int d ) {
	 ...
	 * @param d 交換先の第2インデックス
	 */
	public static void swap ( char[][] array, int a, int b, int c, int d ) {
	 ...
	 * @param d 交換先の第2インデックス
	 */
	public static void swap ( boolean[][] array, int a, int b, int c, int d ) {
	 ...
	 * @param d 交換先の第2インデックス
	 */
	public static <E> void swap ( E[][] array, int a, int b, int c, int d ) {
...
final class SimplePrinter extends PrintWriter {
	...
	public void println ( double[][] arrays, char c ) {
		for ( double[] array: arrays ) {
			println( array, c );
		}
	}
