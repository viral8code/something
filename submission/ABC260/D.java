...
class Main{
	...
	public static void main(String[] args)throws IOException{
		...
		int[] P = new int[N];
		for(int i=0;i<N;i++)P[i]=ss.nextInt()-1;
	...
	public static int upsearch(ArrayList<LinkedList<Integer>> nums,int num){
