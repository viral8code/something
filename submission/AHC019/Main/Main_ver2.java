...
//////////////////処理3//////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//シルエット1
		boolean[][][] checked1 = new boolean[D][D][D];
		for(int i=0;i<D;i++){
			for(int j=0;j<D;j++){
				for(int k=D-1;k>=0;k--){
					if(uf1.root(i*D*D+j*D+k+1)>0&&!checked1[i][j][k]){
						checked1[i][j][k] = true;
						int sum1 = 0;
						for(int jj=j;jj<D;jj++){
							if(uf1.root(i*D*D+jj*D+k+1)==0)
								break;
							checked1[i][jj][k] = true;
							sum1++;
						}
						int sum2 = 0;
		...
		//シルエット2
		boolean[][][] checked2 = new boolean[D][D][D];
		for(int i=0;i<D;i++){
			for(int j=0;j<D;j++){
				for(int k=D-1;k>=0;k--){
					if(uf2.root(i*D*D+j*D+k+1)>0&&!checked2[i][j][k]){
						checked2[i][j][k] = true;
						int sum1 = 0;
						for(int jj=j;jj<D;jj++){
							if(uf2.root(i*D*D+jj*D+k+1)==0)
								break;
							checked2[i][jj][k] = true;
							sum1++;
						}
						int sum2 = 0;
						for(int kk=k;kk>=0;kk--){
