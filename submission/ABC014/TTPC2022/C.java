...
class Main{
	...
	public static void main(String[] args){
		...
		*/////////////
		...
		int[] B = System.in.nextInt(N);
		int[] C = System.in.nextInt(N);
		int[] D = System.in.nextInt(N);
		int[] E = System.in.nextInt(N);
		System.sort(A);
		System.sort(B);
		System.sort(C);
		System.sort(D);
		...
		int ans = 0;
		for(int a:A){
			int B1 = System.overSearch(B,a);
			int B2 = N-1-System.upSearch(B,a);
			int C1 = System.overSearch(C,a);
			int C2 = N-1-System.upSearch(C,a);
			int D1 = System.overSearch(D,a);
			int D2 = N-1-System.upSearch(D,a);
			int E1 = System.overSearch(E,a);
			int E2 = N-1-System.upSearch(E,a);
			long sum = (((long)B1*C1%mod)*D2%mod)*E2%mod;
			sum += (((long)B1*D1%mod)*C2%mod)*E2%mod;
			sum %= mod;
			sum += (((long)B1*E1%mod)*C2%mod)*D2%mod;
			sum %= mod;
			sum += (((long)C1*D1%mod)*B2%mod)*E2%mod;
			sum %= mod;
			sum += (((long)C1*E1%mod)*B2%mod)*D2%mod;
			sum %= mod;
			sum += (((long)D1*E1%mod)*B2%mod)*C2%mod;
			ans += sum*a%mod;
			ans %= mod;
		}
		for(int b:B){
			int A1 = System.overSearch(A,b);
			int A2 = N-1-System.upSearch(A,b);
			int C1 = System.overSearch(C,b);
			int C2 = N-1-System.upSearch(C,b);
			int D1 = System.overSearch(D,b);
			int D2 = N-1-System.upSearch(D,b);
			int E1 = System.overSearch(E,b);
			int E2 = N-1-System.upSearch(E,b);
			long sum = (((long)A1*C1%mod)*D2%mod)*E2%mod;
			sum += (((long)A1*D1%mod)*C2%mod)*E2%mod;
			sum %= mod;
			sum += (((long)A1*E1%mod)*C2%mod)*D2%mod;
			sum %= mod;
			sum += (((long)C1*D1%mod)*A2%mod)*E2%mod;
			sum %= mod;
			sum += (((long)C1*E1%mod)*A2%mod)*D2%mod;
			sum %= mod;
			sum += (((long)D1*E1%mod)*A2%mod)*C2%mod;
			ans += sum*b%mod;
			ans %= mod;
		}
		for(int c:C){
			int A1 = System.overSearch(A,c);
			int A2 = N-1-System.upSearch(A,c);
			int B1 = System.overSearch(B,c);
			int B2 = N-1-System.upSearch(B,c);
			int D1 = System.overSearch(D,c);
			int D2 = N-1-System.upSearch(D,c);
			int E1 = System.overSearch(E,c);
			int E2 = N-1-System.upSearch(E,c);
			long sum = (((long)A1*B1%mod)*D2%mod)*E2%mod;
			sum += (((long)A1*D1%mod)*B2%mod)*E2%mod;
			sum %= mod;
			sum += (((long)A1*E1%mod)*B2%mod)*D2%mod;
			sum %= mod;
			sum += (((long)B1*D1%mod)*A2%mod)*E2%mod;
			sum %= mod;
			sum += (((long)B1*E1%mod)*A2%mod)*D2%mod;
			sum %= mod;
			sum += (((long)D1*E1%mod)*A2%mod)*B2%mod;
			ans += sum*c%mod;
			ans %= mod;
		}
		for(int d:D){
			int A1 = System.overSearch(A,d);
			int A2 = N-1-System.upSearch(A,d);
			int B1 = System.overSearch(B,d);
			int B2 = N-1-System.upSearch(B,d);
			int C1 = System.overSearch(C,d);
			int C2 = N-1-System.upSearch(C,d);
			int E1 = System.overSearch(E,d);
			int E2 = N-1-System.upSearch(E,d);
			long sum = (((long)A1*B1%mod)*C2%mod)*E2%mod;
			sum += (((long)A1*C1%mod)*B2%mod)*E2%mod;
			sum %= mod;
			sum += (((long)A1*E1%mod)*B2%mod)*C2%mod;
			sum %= mod;
			sum += (((long)B1*C1%mod)*A2%mod)*E2%mod;
			sum %= mod;
			sum += (((long)B1*E1%mod)*A2%mod)*C2%mod;
			sum %= mod;
			sum += (((long)C1*E1%mod)*A2%mod)*B2%mod;
			ans += sum*d%mod;
			ans %= mod;
		}
		for(int e:E){
			int A1 = System.overSearch(A,e);
			int A2 = N-1-System.upSearch(A,e);
			int B1 = System.overSearch(B,e);
			int B2 = N-1-System.upSearch(B,e);
			int C1 = System.overSearch(C,e);
			int C2 = N-1-System.upSearch(C,e);
			int D1 = System.overSearch(D,e);
			int D2 = N-1-System.upSearch(D,e);
			long sum = (((long)A1*B1%mod)*C2%mod)*D2%mod;
			sum += (((long)A1*C1%mod)*B2%mod)*D2%mod;
			sum %= mod;
			sum += (((long)A1*D1%mod)*B2%mod)*C2%mod;
			sum %= mod;
			sum += (((long)B1*C1%mod)*A2%mod)*D2%mod;
			sum %= mod;
			sum += (((long)B1*D1%mod)*A2%mod)*C2%mod;
			sum %= mod;
			sum += (((long)C1*D1%mod)*A2%mod)*B2%mod;
			ans += sum*e%mod;
			ans %= mod;
		}
...
class Library{
	...
	public long mod = 0;
	public Library(InputStream in,PrintStream out,PrintStream err){
		this(in,out,err,false);
	}
	public Library(InputStream in,PrintStream out,PrintStream err,boolean bool){
		this.in = new SimpleScanner(in);
		this.out = new SimplePrinter(out,bool);
		this.err = new SimplePrinter(err,true);
	}
	public Library(InputStream in,PrintStream out,PrintStream err,int fac,long mod){
		this(in,out,System.err,false);
		makeFact(fac,mod);
	}
	public Library(InputStream in,PrintStream out,PrintStream err,boolean bool,int fac,long mod){
		this(in,out,System.err,bool);
		makeFact(fac,mod);
	}
